...
<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
    <div class="is-scrollbar-hidden grow overflow-y-auto">
        ...
        <div class="mx-4 my-4 h-px bg-slate-200 dark:bg-navy-500"></div>
            ...
            <div class="flex items-center justify-between px-4">
                ...
                <div class="-mr-1.5 flex">
                    ...
                    <button @click="expanded =! expanded" class="btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 transition-transform" :class="expanded && 'rotate-180'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                        <a class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600" href="#">
                            <div class="flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
    <div class="is-scrollbar-hidden flex grow flex-col overflow-y-auto">
        ...
        <ul class="space-y-1">
            <li>
                <a href="#" class="btn relative h-10 w-10 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    <div class="absolute right-0 top-0 flex h-4 min-w-[1rem] items-center justify-center rounded-full bg-primary px-1 text-tiny font-medium leading-none text-white dark:bg-accent">
                        2
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
...
<div class="flex items-center justify-between space-x-2 px-[var(--margin-x)] py-5 transition-all duration-[.25s]">
    <div class="flex items-center space-x-1">
        <h3 class="line-clamp-1 text-lg font-medium text-slate-700 dark:text-navy-50">
            Banking App
        </h3>
        <button class="btn hidden h-8 w-8 rounded-full p-0 font-medium text-error hover:bg-error/20 focus:bg-error/20 active:bg-error/25 sm:inline-flex">
    ...
    <div class="flex space-x-1">
        <div class="flex -space-x-2">
            <div class="avatar h-6 w-6 hover:z-10 sm:h-8 sm:w-8">
                <img class="rounded-full border-2 border-slate-50 dark:border-navy-900" src="/images/app/avatar-1.jpg" alt="avatar" />
            </div>
            <div class="avatar h-6 w-6 hover:z-10 sm:h-8 sm:w-8">
                <img class="rounded-full border-2 border-slate-50 dark:border-navy-900" src="/images/app/avatar-2.jpg" alt="avatar" />
            </div>
            <div class="avatar h-6 w-6 hover:z-10 sm:h-8 sm:w-8">
                <img class="rounded-full border-2 border-slate-50 dark:border-navy-900" src="/images/app/avatar-3.jpg" alt="avatar" />
            </div>
            <div class="avatar hidden h-6 w-6 hover:z-10 sm:inline-flex sm:h-8 sm:w-8">
                <img class="rounded-full border-2 border-slate-50 dark:border-navy-900" src="/images/app/avatar-4.jpg" alt="avatar" />
            </div>
        ...
        <button class="btn h-6 w-6 rounded-full p-0 font-medium text-info hover:bg-info/20 focus:bg-info/20 active:bg-info/25 sm:h-8 sm:w-8">
        ...
        <div class="flex">
            <button class="btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:hidden sm:h-8 sm:w-8">
            ...
            <button class="btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:h-8 sm:w-8">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                </svg>
            </button>

            <button x-data="{isImportant:true}" @click="isImportant =! isImportant" class="btn hidden h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:inline-flex sm:h-8 sm:w-8">
                <svg x-show="!isImportant" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                </svg>
                <svg x-show="isImportant" xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5 text-primary dark:text-accent" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
            </button>

            <button @click="$dispatch('show-drawer', { drawerId: 'kanban-setting-drawer' })" class="btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:h-8 sm:w-8">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
...
<div class="flex h-[calc(100vh-8.5rem)] flex-grow flex-col">
    <div x-init="Sortable.create($el,{
            ...
            <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5" x-init="Sortable.create($el,{
                    ...
                    <div class="flex space-x-3 px-2.5 pb-2 pt-1.5">
                        ...
                        <div class="flex-1 space-y-2">
                            ...
                            <div class="flex flex-wrap space-x-1">
                                <div class="badge space-x-1 bg-slate-150 px-1.5 py-1 text-slate-800 dark:bg-navy-500 dark:text-navy-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                    <span> Sep 12</span>
                                </div>
                                <div class="badge bg-secondary/10 px-1.5 py-1 text-secondary dark:bg-secondary-light/15 dark:text-secondary-light">
                                    Update
                                </div>
                                <div class="badge space-x-1 bg-info/10 px-1.5 py-1 text-info dark:bg-info/15">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="flex items-end justify-between pt-1">
                                <div class="flex flex-wrap -space-x-1.5">
                                    ...
                                    <div class="avatar h-5 w-5 hover:z-10">
                                        <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-5.jpg" alt="avatar" />
                                    </div>

                                    <div class="avatar h-5 w-5 hover:z-10">
                                        <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-6.jpg" alt="avatar" />
                                    </div>
                                </div>
                    ...
                    <div class="space-y-3 px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                <p class="line-clamp-2 font-medium tracking-wide text-slate-600 dark:text-navy-100">
                                    Sync With Google Analytics
                                </p>
                                <svg xmlns="http://www.w3.org/2000/svg" class="-mr-1.5 h-3.5 w-3.5 shrink-0 text-error" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="space-y-2 px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="-mr-1.5 h-3.5 w-3.5 shrink-0 text-info" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd" />
                                </svg>
                            </div>
                        </div>
                        <div class="flex flex-wrap space-x-1">
                            ...
                            <div class="badge bg-info/10 px-1.5 py-1 text-info dark:bg-info/15">
                                Create
                            </div>
                            <div class="badge space-x-1 bg-error/10 px-1.5 py-1 text-error dark:bg-error/15">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                <span>4/5</span>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <img src="/images/object/object-1.jpg" class="rounded-lg object-cover object-center" alt="image" />
                            <img src="/images/object/food-4.jpg" class="rounded-lg object-cover object-center" alt="image" />
                        ...
                        <div class="flex items-end justify-between pt-1">
                            <div class="flex flex-wrap -space-x-1.5">
                                ...
                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-9.jpg" alt="avatar" />
                                </div>

                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-10.jpg" alt="avatar" />
                                </div>
                            </div>
                            <div class="flex items-center space-x-2 text-xs text-slate-400 dark:text-navy-300">
                                <div class="flex items-center space-x-0.5">
                ...
                <div class="card cursor-pointer shadow-sm">
                    <div class="space-y-3 rounded-lg bg-success/10 px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                <p class="line-clamp-2 font-medium tracking-wide text-success">
                                    Improve animation loader
                                </p>
                            </div>
                        </div>
                        <div class="flex flex-wrap space-x-1">
                            <div class="badge space-x-1 bg-success/10 px-1.5 py-1 text-success dark:bg-success/15">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span> Sep 12</span>
                            </div>
                            <div class="badge bg-warning/10 px-1.5 py-1 text-warning dark:bg-warning/15">
                                Performance
                            </div>
                        </div>
                        <div class="flex items-end justify-between">
            ...
            <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5" x-init="Sortable.create($el,{
                    ...
                    <div class="px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="-mr-1.5 h-3.5 w-3.5 shrink-0 text-secondary dark:text-secondary-light" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd" />
                                </svg>
                            </div>
                ...
                <div class="card cursor-pointer shadow-sm">
                    <div class="rounded-lg bg-warning/10 px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                <p class="line-clamp-2 font-medium tracking-wide text-warning">
                                    Pay App Wages [1200$]
                                </p>
                            </div>
                        </div>
                        <div class="mt-2 flex flex-wrap space-x-1">
                            <div class="badge space-x-1 bg-warning/10 px-1.5 py-1 text-warning dark:bg-warning/15">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span> Sep 12</span>
                            </div>
                            <div class="badge bg-secondary/10 px-1.5 py-1 text-secondary dark:bg-secondary/15 dark:text-secondary-light">
                                Performance
                            </div>
                        </div>
                        <div class="mt-3 flex items-end justify-between">
                            <div class="flex flex-wrap -space-x-1.5">
                                ...
                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-14.jpg" alt="avatar" />
                                </div>

                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-18.jpg" alt="avatar" />
                                </div>
                            </div>
                            <div class="flex items-center space-x-2 text-xs text-slate-400 dark:text-navy-300">
                                <div class="flex items-center space-x-0.5">
                        ...
                        <div class="flex-1 space-y-2">
                            <div>
                                <div class="flex justify-between">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="-mr-1.5 h-3.5 w-3.5 shrink-0 text-success" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                    ...
                    <div class="px-2.5 pb-2 pt-1.5">
                        ...
                        <div class="mt-3 flex flex-col space-y-2">
                            <label class="inline-flex items-center space-x-2">
                                <input checked class="form-checkbox is-basic h-5 w-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" type="checkbox" />
                                <span>Write Article</span>
                            </label>
                            <label class="inline-flex items-center space-x-2">
                                <input class="form-checkbox is-basic h-5 w-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" type="checkbox" />
                                <span>Review</span>
                            </label>
                            <label class="inline-flex items-center space-x-2">
                                <input class="form-checkbox is-basic h-5 w-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" type="checkbox" />
                        ...
                        <div class="mt-3 flex items-end justify-between">
                            <div class="flex flex-wrap -space-x-1.5">
                                ...
                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-3.jpg" alt="avatar" draggable="false" />
                                </div>

                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-7.jpg" alt="avatar" draggable="false" />
                                </div>
                            </div>
                            <div class="flex items-center space-x-2 text-xs text-slate-400 dark:text-navy-300">
                                <div class="flex items-center space-x-0.5">
        ...
        <div class="board-draggable relative flex max-h-full w-72 shrink-0 flex-col">
            <div class="board-draggable-handler flex items-center justify-between px-0.5 pb-3">
                <div class="flex items-center space-x-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-secondary/10 text-secondary dark:bg-secondary-light/15 dark:text-secondary-light">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="is-scrollbar-hidden relative space-y-2.5 overflow-y-auto p-0.5" x-init="Sortable.create($el,{
                ...
                <div class="card cursor-pointer shadow-sm">
                    <div class="rounded-lg bg-info/10 px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                <p class="line-clamp-2 font-medium tracking-wide text-info">
                                    Join To Discussion
                                </p>
                            </div>
                        </div>
                        <div class="mt-2 flex flex-wrap space-x-1">
                            ...
                            <div class="badge bg-primary/10 px-1.5 py-1 text-primary dark:bg-accent-light/15 dark:text-accent-light">
                                Support
                            </div>
                        </div>
                        <div class="mt-3 flex items-end justify-between">
                            <div class="flex flex-wrap -space-x-1.5">
                                ...
                                <div class="avatar h-5 w-5 hover:z-10">
                                    <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-8.jpg" alt="avatar" />
                                </div>
        ...
        <div class="board-draggable relative flex max-h-full w-72 shrink-0 flex-col">
            <div class="board-draggable-handler flex items-center justify-between px-0.5 pb-3">
                <div class="flex items-center space-x-2">
                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-success/10 text-success dark:bg-success/15">
                    ...
                    <div class="px-2.5 pb-2 pt-1.5">
                        <div>
                            <div class="flex justify-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="-mr-1.5 h-3.5 w-3.5 shrink-0 text-warning" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd" />
                                </svg>
                            </div>
                ...
                <div class="card cursor-pointer shadow-sm">
                    <div class="flex space-x-3 rounded-lg bg-error/10 px-2.5 pb-2 pt-1.5">
                        ...
                        <div class="flex-1">
                            <div>
                                <div class="flex justify-between">
                                    <p class="line-clamp-2 font-medium tracking-wide text-error">
                                        Backup System
                                    </p>
                                </div>
                                <p class="mt-px text-xs text-slate-400 dark:text-navy-300">
                            ...
                            <div class="mt-3 flex items-end justify-between">
                                <div class="flex flex-wrap -space-x-1.5">
                                    ...
                                    <div class="avatar h-5 w-5 hover:z-10">
                                        <img class="rounded-full ring-1 ring-white dark:ring-navy-700" src="/images/app/avatar-13.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2 text-xs text-slate-400 dark:text-navy-300">
                                    <div class="flex items-center space-x-0.5">
    ...
    <div class="fixed right-0 top-0 z-[101] h-full w-full sm:w-80">
        <div class="flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200 dark:bg-navy-700" x-show="showDrawer" x-transition:enter="ease-out" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="ease-in" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full">
            <div class="flex h-14 items-center justify-between bg-slate-150 p-4 dark:bg-navy-800">
                ...
                <div class="-mr-1.5 flex">
                    <button x-data="{isImportant:false}" @click.stop="isImportant =! isImportant" class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        <svg x-show="!isImportant" xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                        </svg>
                        <svg x-show="isImportant" xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5 text-primary dark:text-accent" viewBox="0 0 20 20" fill="currentColor" style="display: none">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                    </button>
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <div class="avatar mt-2 h-20 w-20">
                                        <img class="mask is-squircle" src="/images/app/avatar-1.jpg" alt="avatar" />
                                    </div>
                                </div>
                            </li>
                            <li class="timeline-item">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <div class="mt-4 grid grid-cols-3 gap-3">
                                        ...
                                        <img class="rounded-lg" src="/images/object/object-9.jpg" alt="image" />
                                        <img class="rounded-lg" src="/images/object/object-18.jpg" alt="image" />
                                    </div>
                                    <div class="mt-4">
                                        ...
                                        <div class="mt-2 flex justify-between">
                                            <div class="flex flex-wrap -space-x-2">
                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="/images/app/avatar-2.jpg" alt="avatar" />
                                                </div>
                                                ...
                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="/images/app/avatar-4.jpg" alt="avatar" />
                                                </div>

                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="/images/app/avatar-9.jpg" alt="avatar" />
                                                </div>
                                            </div>
...
<div @click="$dispatch('show-drawer', { drawerId: 'kanban-setting-drawer' })" class="fixed bottom-3 right-3 rounded-full bg-white dark:bg-navy-700">
    <button class="btn h-14 w-14 rounded-full bg-success p-0 font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 sm:hidden">
