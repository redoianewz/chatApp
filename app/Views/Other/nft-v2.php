    ...
    <div class="col-span-12 space-y-4 sm:space-y-5 lg:col-span-8 lg:space-y-6 xl:col-span-9">
        <div>
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="border-b border-dotted border-current pb-0.5 font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70">View All</a>
            </div>
            <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-5">
                <div class="card items-center pb-5 text-center">
                    <img class="h-24 w-full rounded-t-lg object-cover object-center" src="/images/object/object-1.jpg" alt="image" />
                    <div class="avatar -mt-12 h-20 w-20">
                        <img class="rounded-full border-2 border-white dark:border-navy-700" src="/images/app/avatar-11.jpg" alt="avatar" />
                    </div>
                    <div class="mt-1.5 px-2">
                        <a href="#" class="line-clamp-1 text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            Travis Fuller
                        </a>
                        <p class="text-xs text-slate-400 dark:text-navy-300">
                            USA, Washington DC
                        </p>
                        <button class="btn mt-4 h-8 min-w-[7rem] rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                            Follow
                        </button>
                    </div>
                </div>
                <div class="card items-center pb-5 text-center">
                    <img class="h-24 w-full rounded-t-lg object-cover object-center" src="/images/object/object-2.jpg" alt="image" />
                    <div class="avatar -mt-12 h-20 w-20">
                        <img class="rounded-full border-2 border-white dark:border-navy-700" src="/images/app/avatar-7.jpg" alt="avatar" />
                    </div>
                    <div class="mt-1.5 px-2">
                        <a href="#" class="line-clamp-1 text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            Alfredo Elliott
                ...
                <div class="card items-center pb-5 text-center">
                    <img class="h-24 w-full rounded-t-lg object-cover object-center" src="/images/object/object-4.jpg" alt="image" />
                    <div class="avatar -mt-12 h-20 w-20">
                        <img class="rounded-full border-2 border-white dark:border-navy-700" src="/images/app/avatar-19.jpg" alt="avatar" />
                    </div>
                    <div class="mt-1.5 px-2">
                        <a href="#" class="line-clamp-1 text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            Raul Bradley
                ...
                <div class="card items-center pb-5 text-center">
                    <img class="h-24 w-full rounded-t-lg object-cover object-center" src="/images/object/object-7.jpg" alt="image" />
                    <div class="avatar -mt-12 h-20 w-20">
                        <img class="rounded-full border-2 border-white dark:border-navy-700" src="/images/app/avatar-18.jpg" alt="avatar" />
                    </div>
                    <div class="mt-1.5 px-2">
                        <a href="#" class="line-clamp-1 text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                            Henry Curtis
        ...
        <div>
            <div class="flex items-center justify-between">
                ...
                <div class="hidden w-full max-w-xs justify-between space-x-4 text-slate-700 dark:text-navy-100 sm:flex" x-data="{activeTab:'tabAll'}">
                    ...
                    <button @click="activeTab = 'tabMusic'" class="font-medium tracking-wide" :class="activeTab === 'tabMusic' && 'text-primary dark:text-accent-light' ">
                        Music
                    </button>
                    <button @click="activeTab = 'tabMore'" class="font-medium tracking-wide" :class="activeTab === 'tabMore' && 'text-primary dark:text-accent-light' ">
                        More
                    </button>
                </div>

                <div class="flex space-x-1 sm:hidden">
                    <button class="btn h-7 w-7 shrink-0 rounded-full p-0 text-slate-700 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:text-navy-100 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Travis Fuller</a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    952 items
                                </p>
                            </div>
                        </div>
                        <button x-data="{isLiked:false}" @click="isLiked = !isLiked" class="btn h-9 w-9 bg-slate-150 p-0 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                            <i x-show="!isLiked" class="fa-regular fa-heart text-lg"></i>
                            <i x-show="isLiked" class="fa-solid fa-heart text-lg text-error"></i>
                        </button>
                    </div>
                    <div class="relative mt-4">
                        <img class="h-56 w-full rounded-lg object-cover object-center" src="/images/object/object-10.jpg" alt="image" />
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Katrina West</a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    896 items
                                </p>
                            </div>
                    ...
                    <div class="relative mt-4">
                        <img class="h-56 w-full rounded-lg object-cover object-center" src="/images/object/object-12.jpg" alt="image" />
                        <div class="absolute top-0 h-full w-full rounded-lg bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                        <div class="absolute top-0 flex h-full w-full items-center justify-center opacity-0 group-hover:opacity-100">
                            <button class="btn min-w-[7rem] border border-white/10 bg-white/20 text-white backdrop-blur hover:bg-white/30 focus:bg-white/30">
                                Place a Bid
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Raul Bradley</a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    1,643 items
                                </p>
                            </div>
                        </div>
                        <button x-data="{isLiked:true}" @click="isLiked = !isLiked" class="btn h-9 w-9 bg-slate-150 p-0 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                            <i x-show="!isLiked" class="fa-regular fa-heart text-lg"></i>
                            <i x-show="isLiked" class="fa-solid fa-heart text-lg text-error"></i>
                        </button>
                    </div>
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Henry Curtis</a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    163 items
                                </p>
                            </div>
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Lance Tucker
                                </a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    533 items
                                </p>
                    ...
                    <div class="relative mt-4">
                        <img class="h-56 w-full rounded-lg object-cover object-center" src="/images/object/object-15.jpg" alt="image" />
                        <div class="absolute top-0 h-full w-full rounded-lg bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                        <div class="absolute top-0 flex h-full w-full items-center justify-center opacity-0 group-hover:opacity-100">
                            <button class="btn min-w-[7rem] border border-white/10 bg-white/20 text-white backdrop-blur hover:bg-white/30 focus:bg-white/30">
                                Place a Bid
                ...
                <div class="card group p-3">
                    <div class="flex items-center justify-between space-x-2 px-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                <a href="#" class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">Henry Curtis
                                </a>
                                <p class="text-xs text-primary dark:text-accent-light">
                                    669 items
                                </p>
                    ...
                    <div class="relative mt-4">
                        <img class="h-56 w-full rounded-lg object-cover object-center" src="/images/object/object-16.jpg" alt="image" />
                        <div class="absolute top-0 h-full w-full rounded-lg bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                        <div class="absolute top-0 flex h-full w-full items-center justify-center opacity-0 group-hover:opacity-100">
                            <button class="btn min-w-[7rem] border border-white/10 bg-white/20 text-white backdrop-blur hover:bg-white/30 focus:bg-white/30">
                                Place a Bid
        ...
        <div class="card bg-gradient-to-br from-info to-info-focus p-4">
            ...
            <div class="mt-10">
                ...
                <div class="flex justify-between">
                    ...
                    <img src="images/payments/cc-visa-white.svg" class="w-10 rounded-lg" alt="creditcard" />
                </div>
            </div>
        </div>
        ...
        <div class="card p-3">
            ...
            <div class="mt-3 p-1">
                <div class="flex items-center justify-between space-x-1">
                    ...
                    <button x-data="{isLiked:true}" @click="isLiked = !isLiked" class="btn h-7 w-7 rounded-full bg-slate-150 p-0 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
        ...
        <div class="card px-4 pb-4">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2">
                        <div class="avatar h-10 w-10">
                            <img class="mask is-hexagon" src="/images/app/avatar-2.jpg" alt="avatar" />
                        </div>
                        <div>
                            <p class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">
                                You Followed
                            </p>
                            <p></p>
                            <p class="text-xs text-slate-400 dark:text-navy-300">
                ...
                <div class="flex items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2">
                        <div class="avatar h-10 w-10">
                            <img class="mask is-hexagon" src="/images/app/avatar-3.jpg" alt="avatar" />
                        </div>
                        <div>
                            <p class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">
                                New NFT
                ...
                <div class="flex items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2">
                        <div class="avatar h-10 w-10">
                            <img class="mask is-hexagon" src="/images/app/avatar-4.jpg" alt="avatar" />
                        </div>
                        <div>
                            <p class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">
                                You liked NFT
                ...
                <div class="flex items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2">
                        <div class="avatar h-10 w-10">
                            <img class="mask is-hexagon" src="/images/app/avatar-5.jpg" alt="avatar" />
                        </div>
                        <div>
                            <p class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">
                                New NFT
                ...
                <div class="flex items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2">
                        <div class="avatar h-10 w-10">
                            <img class="mask is-hexagon" src="/images/app/avatar-6.jpg" alt="avatar" />
                        </div>
                        <div>
                            <p class="line-clamp-1 font-medium text-slate-600 dark:text-navy-100">
                                Followed
