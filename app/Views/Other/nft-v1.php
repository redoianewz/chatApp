    ...
    <div class="col-span-12 lg:col-span-8 xl:col-span-9">
        ...
        <div class="is-scrollbar-hidden overflow-x-auto">
            <div class="flex w-max space-x-3">
                <a href="#" class="tag h-7 rounded-full bg-primary text-xs+ text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                    🔥 All
                </a>

                <a href="#" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    🎨 Art
                </a>
                <a href="#" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    🎵 Music
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card p-2 pb-3">
                <div class="relative w-full">
                    <img class="h-56 w-full rounded-xl object-cover object-center" src="/images/object/object-12.jpg" alt="image" />
                    <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                        <div class="flex justify-end">
                            <button class="btn h-7 w-7 rounded-full bg-black/20 p-0 hover:bg-black/30 focus:bg-black/30">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mx-2 mt-3">
                    ...
                    <a href="#" class="mt-1.5 line-clamp-1 text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                        The Runner #265
                    </a>
            ...
            <div class="card p-2 pb-3">
                <div class="relative w-full">
                    <img class="h-56 w-full rounded-xl object-cover object-center" src="/images/object/object-11.jpg" alt="image" />
                    <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                        <div class="flex justify-end">
                            <button class="btn h-7 w-7 rounded-full bg-black/20 p-0 hover:bg-black/30 focus:bg-black/30">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card p-2 pb-3">
                <div class="relative w-full">
                    <img class="h-56 w-full rounded-xl object-cover object-center" src="/images/object/object-13.jpg" alt="image" />
                    <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                        <div class="flex justify-end">
                            <button class="btn h-7 w-7 rounded-full bg-black/20 p-0 hover:bg-black/30 focus:bg-black/30">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tbody>
                            <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                    <div class="flex items-center space-x-4">
                                        <div class="avatar">
                                            <img class="rounded-full" src="/images/object/object-15.jpg" alt="avatar" />
                                        </div>

                                        <span class="font-medium text-slate-700 dark:text-navy-100">Abstrac Point</span>
                                    </div>
                                </td>
                            ...
                            <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                    <div class="flex items-center space-x-4">
                                        <div class="avatar">
                                            <img class="rounded-full" src="/images/object/object-16.jpg" alt="avatar" />
                                        </div>

                                        <span class="font-medium text-slate-700 dark:text-navy-100">3D Cube Art</span>
                                    </div>
                                </td>
                                <td class="whitespace-nowrap px-4 py-3 font-medium text-slate-700 dark:text-navy-100 sm:px-5">
                                    $6,923.00
                            ...
                            <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                    <div class="flex items-center space-x-4">
                                        <div class="avatar">
                                            <img class="rounded-full" src="/images/object/object-17.jpg" alt="avatar" />
                                        </div>

                                        <span class="font-medium text-slate-700 dark:text-navy-100">The Digital Art</span>
                                    </div>
                                </td>
                                <td class="whitespace-nowrap px-4 py-3 font-medium text-slate-700 dark:text-navy-100 sm:px-5">
                                    $8,367.00
                            ...
                            <tr class="border-y border-transparent">
                                <td class="whitespace-nowrap rounded-bl-lg px-4 py-3 sm:px-5">
                                    <div class="flex items-center space-x-4">
                                        <div class="avatar">
                                            <img class="rounded-full" src="/images/object/object-18.jpg" alt="avatar" />
                                        </div>

                                        <span class="font-medium text-slate-700 dark:text-navy-100">Geomatro Art</span>
                                    </div>
                                </td>
                                <td class="whitespace-nowrap px-4 py-3 font-medium text-slate-700 dark:text-navy-100 sm:px-5">
                                    $35,496.00
                                ...
                                <td class="whitespace-nowrap rounded-br-lg px-4 py-3 text-slate-700 dark:text-navy-100 sm:px-5">
                                    5,644
                                </td>
                            </tr>
                        </tbody>
    ...
    <div class="col-span-12 space-y-4 sm:space-y-5 lg:col-span-4 lg:mt-6 lg:space-y-6 xl:col-span-3">
        <div class="card bg-gradient-to-br from-purple-500 to-indigo-600 px-4 pb-4">
            ...
            <div class="flex w-9/12 items-center space-x-1">
                <p class="line-clamp-1 text-xs text-indigo-100">
            ...
            <button class="btn mt-6 w-full border border-white/10 bg-white/20 text-white hover:bg-white/30 focus:bg-white/30">
                Up Your Balance
            </button>
        </div>
        ...
        <div class="card pb-4">
                    ...
                    <div x-data="usePopper({
                     ...
                     modifiers: [
                        ...
                        <div x-ref="popperRef" class="avatar h-10 w-10">
                            <img class="mask is-squircle" src="/images/app/avatar-2.jpg" alt="avatar" />
                        </div>
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div class="popper-box">
                                <div class="flex w-48 flex-col items-center rounded-md border border-slate-150 bg-white p-3 text-center dark:border-navy-600 dark:bg-navy-700">
                                    ...
                                    <a href="#" class="font-inter text-xs tracking-wide hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">@konnoraccount
                                    </a>
                                ...
                                <div class="h-4 w-4" data-popper-arrow>
                                    <svg viewBox="0 0 16 9" xmlns="http://www.w3.org/2000/svg" class="absolute h-4 w-4" fill="currentColor">
                                        <path class="text-slate-150 dark:text-navy-600" d="M1.5 8.357s-.48.624 2.754-4.779C5.583 1.35 6.796.01 8 0c1.204-.009 2.417 1.33 3.76 3.578 3.253 5.43 2.74 4.78 2.74 4.78h-13z" />
                                        <path class="text-white dark:text-navy-700" d="M0 9s1.796-.017 4.67-4.648C5.853 2.442 6.93 1.293 8 1.286c1.07-.008 2.147 1.14 3.343 3.066C14.233 9.006 15.999 9 15.999 9H0z" />
                                    </svg>
                                </div>
                            </div>
                        </div>
            ...
            <div class="is-scrollbar-hidden flex space-x-4 overflow-y-auto px-4">
                <div class="w-28 shrink-0 text-xs">
                    <img class="w-28 rounded-lg object-cover object-center" src="/images/object/object-12.jpg" alt="images" />
                    <a href="#" class="mt-1.5 line-clamp-1 font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Cube Store #025</a>
                    <p class="mt-1.5">
                        <span class="font-semibold text-slate-700 dark:text-navy-100">
                            <i class="fa-brands fa-ethereum text-sm+"></i>
                            5.01
                ...
                <div class="w-28 shrink-0 text-xs">
                    <img class="w-28 rounded-lg object-cover object-center" src="/images/object/object-15.jpg" alt="images" />
                    <a href="#" class="mt-1.5 line-clamp-1 font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Punkiber #5764</a>
                    <p class="mt-1.5">
                        <span class="font-semibold text-slate-700 dark:text-navy-100">
                            <i class="fa-brands fa-ethereum text-sm+"></i>
                            7.63
                ...
                <div class="w-28 shrink-0 text-xs">
                    <img class="w-28 rounded-lg object-cover object-center" src="/images/object/object-17.jpg" alt="images" />
                    <a href="#" class="mt-1.5 line-clamp-1 font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">The Runner #0456</a>
                    <p class="mt-1.5">
                        <span class="font-semibold text-slate-700 dark:text-navy-100">
                            <i class="fa-brands fa-ethereum text-sm+"></i>
                            19.33
